...
class EmployeeSeedTable extends Seeder
{
    ...
    public function run()
    {
        $users =
            [
            ['id' => '4', 'username' => 'Manager', 'email' => 'manager@mrhotel.rw', 'password' => '$2y$10$TKh8H1.PfQx37YgCzwiKb.KjNyWgaHb9cbcoQgdIVFlYg7B77UdFm', 'role_id' => '1', 'department_id' => '1', 'position_id' => '1'],
